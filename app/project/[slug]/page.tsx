          ...
          <div>
            ...
            <div className="bg-surface border border-[#eef4f7] rounded-2xl p-9 mt-10">
              ...
              <dl className="grid grid-cols-1 tablet:grid-cols-2 gap-7 tablet:gap-x-10">
                {project.location && (
                  <InfoItem label="Местоположение" value={project.location} />
                )}
                <InfoItem label="Отрасль" value={project.industry} />
                <InfoItem label="Особенности" value={project.features} full />
                <InfoItem label="Решаемые задачи" value={project.tasks} full />
                <InfoItem
                  label="Преимущества решения"
