...
export const projectsData: ProjectsData = {
  heroIntro:
    "Сегодня компания принимает участие в проектах строительства, водоснабжения и энергетики — от атомной и теплоэнергетики до нефтяной, химической и горнодобывающей промышленности. Продукция Liancheng широко используется в коммунальном хозяйстве, охране водных ресурсов, строительстве, противопожарной защите и электроэнергетике. Компания реализует большое количество локальных и зарубежных типовых проектов; оборудование применяется в проектах всемирно известных компаний в Китае.",
  compact: [
    "Столичный аэропорт",
  ...
  featured: [
    {
      ...
      benefits:
        "Надёжное насосное оборудование Liancheng обеспечивает стабильную работу инженерных систем объекта мирового уровня.",
      description:
    ...
    },
    {
      ...
      equipment: "Связанная продукция",
      benefits:
        "Оборудование Liancheng обеспечивает надёжную работу систем водоснабжения и дренажа уникального культурного объекта.",
      description:
    ...
    },
    {
      ...
      equipment: "Связанная продукция",
      benefits:
        "Насосное оборудование Liancheng соответствует высоким требованиям к надёжности объектов гражданской авиации.",
      description:
    ...
    },
    {
      ...
      equipment: "Связанная продукция",
      benefits:
        "Оборудование Liancheng обеспечивает стабильную работу сложных гидротехнических систем аквариума.",
      description:
    ...
    },
    {
      ...
      equipment: "Связанная продукция",
      benefits:
        "Насосные решения Liancheng обеспечивают надёжную работу инженерных систем общественного здания.",
      description:
    ...
    },
    {
      ...
      equipment: "Связанная продукция",
      benefits:
        "Оборудование Liancheng соответствует требованиям крупных транспортных и инфраструктурных объектов.",
      description:
  ...
  industries: [
    ...
    },
    {
      ...
      intro:
        "Компания Liancheng поставляет разнообразные насосы для перекачки жидкости для многих промышленных предприятий.",
