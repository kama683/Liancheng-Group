...
export const CATALOG_INTRO =
  "Shanghai Liancheng (Group) Co., Ltd. — известное крупномасштабное предприятие, специализирующееся на исследованиях и производстве более 3000 видов продукции, включая насосы, двигатели, запорно-регулирующую арматуру, системы подачи жидкости, электрических систем управления и оборудования для защиты окружающей среды.";
